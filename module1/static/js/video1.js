...
function loadMusic(indexNumb){
   mainVideo.src = `/static/media/${allVideos[indexNumb - 1].src}.mp4`;
...
for(let i = 0; i < allVideos.length; i++){
   let liTag = `<li li-index="${i + 1}">
      ...
      <video class="${allVideos[i].id}" src="/static/media/${allVideos[i].src}.mp4" style="display: none;" title="${allVideos[i].name}"></video>
